<?php 
    ...
    $sql1 = "SELECT * FROM application_janaki_bose_scholarship WHERE ph_no = $phone";
    ...
    if ($result1) {
        if (mysqli_num_rows($result1) > 0) {
         ...
         // echo 'found!';
		   ...
		   $sql3 = "INSERT INTO  application_janaki_bose_scholarship VALUES('$new_app_id', '".$appin['c_code']."', '".$appin['s_name']."', '".$appin['aadhar']."', '".$appin['reg_no']."', '".$appin['prev_year_perc']."', 'Application Submitted','".$_SESSION['ph_no']."')";
           $resultin = mysqli_query($conn, $sql3);
           $sql7 = "SELECT * FROM application_janaki_bose_scholarship WHERE ph_no = $phone";
